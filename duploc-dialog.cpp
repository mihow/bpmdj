/****************************************************************************
** Form implementation generated from reading ui file 'duploc-dialog.ui'
**
...
/*
 *  Constructs a DuplocDialog as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  TRUE to construct a modal dialog.
 */
DuplocDialog::DuplocDialog( QWidget* parent, const char* name, bool modal, WFlags fl )
    : QDialog( parent, name, modal, fl ),
      image0( (const char **) image0_data )
{
    if ( !name )
	setName( "DuplocDialog" );
    DuplocDialogLayout = new QGridLayout( this, 1, 1, 11, 6, "DuplocDialogLayout"); 

    matrixview = new QLabel( this, "matrixview" );
    matrixview->setPixmap( image0 );
    matrixview->setScaledContents( TRUE );

    DuplocDialogLayout->addMultiCellWidget( matrixview, 0, 0, 0, 1 );

    lefttext = new QTextBrowser( this, "lefttext" );
    QFont lefttext_font(  lefttext->font() );
    lefttext_font.setFamily( "Courier New" );
    lefttext_font.setPointSize( 8 );
    lefttext->setFont( lefttext_font ); 

    DuplocDialogLayout->addWidget( lefttext, 1, 0 );

    righttext = new QTextBrowser( this, "righttext" );
    QFont righttext_font(  righttext->font() );
    righttext_font.setFamily( "Courier New" );
    righttext_font.setPointSize( 8 );
    righttext->setFont( righttext_font ); 

    DuplocDialogLayout->addWidget( righttext, 1, 1 );
    languageChange();
    resize( QSize(312, 228).expandedTo(minimumSizeHint()) );
 ...
 *  language.
 */
void DuplocDialog::languageChange()
{
    setCaption( tr( "Duploc" ) );
    lefttext->setText( tr( "left" ) );
    righttext->setText( tr( "right" ) );
}
