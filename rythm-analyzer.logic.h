...
****/
#ifndef __BPMDJ___RYTHM_ANALYZER_LOGIC_H__
#define __BPMDJ___RYTHM_ANALYZER_LOGIC_H__
using namespace std;
#line 1 "rythm-analyzer.logic.h++"
#include "songplayer.h"
#include "rythm-analyzer.h"
#include "analyzer.h"
#include "types.h"

class RythmDialogLogic : public RythmDialog, public Analyzer
{
  Q_OBJECT
public:
