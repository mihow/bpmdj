...
****/
#ifndef __loaded__data_test_cpp__
#define __loaded__data_test_cpp__
using namespace std;
#line 1 "data-test.c++"
#include "om-data.h"
...
int main(int, char*[])
{
  ...
  token["ZZZZZZ"]=String("{Alfa : 'Moonbase\n"
	     ...
	     "         Wopper : HEY};\n"
	     " Delta : 'Blahlbah';\n"
	     " Gamma : <+12w +0w +0w +0w +0w +0w +0w +0w +0w +0w +0w +0w +0w"
			 " +0w +0w +19w>;\n"
	     " Kappa : <<+10b +0b +0b +0b +0b +0b +0b +0b +0b +0b +20b> <> <>"
			 " <> <> <> <> <> <> <> <+30b +0b +0b +0b +0b +0b +0b"
			 " +0b +0b +0b\n");
  texter.write(token);
  printf("Finished\n");
}
#endif // __loaded__data_test_cpp__
